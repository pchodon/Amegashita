...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 17 15:11:59 2023
...
class simulate_circuit():
    ...
    def __init__(self,Vdd,lp,wp,ln,wn):
...
if __name__ == '__main__':
   ...
   for nmos_w in range(1000,10000,1000): 
    pmos_w= 1500
    inv = simulate_circuit(1.1,130,nmos_w,130,pmos_w)
#   inv = simulate_circuit(1.1,130,2500,150,2500)
